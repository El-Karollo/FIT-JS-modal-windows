...
| top            | Top position where the window will open                                                        | If you do not specify any position (top, left, right) then the window will open in the middle of the page. If you want the window to open at the bottom of the page you need to specify in `top`: calc(100vh - windowHeightpx). For example: top: `` calc(100vh - 200px)``.                  |
| left           | Left position where the window will open                                                       | If you do not specify any position (top, left, right) then the window will open in the middle of the page                                                          |
| right          | Right position where the window will open                                                      | If you do not specify any position (top, left, right) then the window will open in the middle of the page                                                          |
